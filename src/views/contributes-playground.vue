...
import { timeFormatDefaultLocale, type TimeLocaleDefinition } from "d3-time-format";
import zhCN from "d3-time-format/locale/zh-CN";
import { Repository, useRepositories } from "./use-repositories.ts";
timeFormatDefaultLocale(zhCN as TimeLocaleDefinition);
